...
$stmt = $pdo->prepare("SELECT r.*, COALESCE(o.name, 'Nenhuma') occasion_name FROM reservations r LEFT JOIN occasions o ON o.id = r.occasion_id WHERE r.customer_id = ? ORDER BY r.reservation_date DESC, r.reservation_time DESC");
...
<section class="panel">
    ...
    <div class="table-wrap">
        <table>
            <thead><tr><th>Data</th><th>Hora</th><th>Pessoas</th><th>Ocasiao</th><th>Status</th></tr></thead>
            <tbody>
